...
$authority_id = '';
$authority_name = ''; // Add a new variable for authority name

$result = null; // Initialize $result variable

if (isset($_POST['submit'])) {
    // Get user input
    $authority_name = $_POST['authority_search']; // Get authority name input
    ...
    // Query to retrieve all members when "View All" is clicked
...
<body>
    ...
    <?php
    // Display search results only if $result is not null
    if ($result !== null) {
    ?>
