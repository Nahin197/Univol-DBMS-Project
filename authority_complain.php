...
if (isset($_POST['submit'])) {
    ...
    if (empty($event_id)) {
        ...
        // Check if event_id exists in event_details table
    ...
    // If there are no errors, proceed to store in the database
    if (empty(array_filter($errors))) {
        // Check if vol_id and vol_name exist in the volunteer table
