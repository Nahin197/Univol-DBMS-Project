...
if (isset($_GET['student_id'])) {
    ...
    // Query to get volunteer details
    ...
    if ($result->num_rows == 1) {
        ...
        // Handle form submission when "Update" is clicked
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
            ...
            // Update volunteer data in the volunteer table
            ...
            // Redirect to the previous page or wherever you want after the update
            header("Location: admin_vol_page.php");
            exit();
        }
    } else {
        // Volunteer not found, redirect to admin_vol_page.php
        header("Location: admin_vol_page.php");
        exit();
    }
}
    ...
    function confirmDelete() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Redirect to the delete page if the user confirms
