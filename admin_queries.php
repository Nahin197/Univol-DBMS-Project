...
// Handle form submission when "Mark as Done" button is clicked
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    $queryId = $_POST['id'];

    // Update the action of the selected query to 'done'
...
// Retrieve only pending queries from the database
        ...
        <div class="overflow-x-auto">
            <form method="POST" action="admin_queries.php">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        // Display only pending queries in the table
