...
$optionLinks = array(
    "Volunteer" => "volunteerSignup.php", // Assuming you have a page for Volunteer option
    "Club" => "clubSignup.php",           // Assuming you have a page for Club option
    "Authority" => "authoritySignup.php", // Assuming you have a page for Authority option
);
?>
